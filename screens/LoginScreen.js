...
const LoginScreen = ({ navigation }) => {
  // navigation.navigate("HomeScreen");
    ...
    return (
      <Layout style={{flex:
       1, justifyContent: 'center', backgroundColor:'#FF7F36' }}>
        <Layout style={{padding:30,  backgroundColor:'#FF7F36'}}>
          <View>
              ...
              return (
                <>
                  ...
                  <View style={styles.layout}>
                    ...
                    <Button style={{backgroundColor: 'transparent', borderColor:'transparent'}} onPress={()=>{}}><Text style={{color: '#fff'}}>Create an account</Text></Button>
                  </View>
                  <View>
                    <Button style={{ 
